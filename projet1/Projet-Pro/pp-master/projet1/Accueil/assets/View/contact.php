            ...
            <form method="POST" action="#">
                <div class="row pt-5">
                    <div class="col-md-6 text-center form-group<?= isset($errorMessage['lastName']) ? ' has-danger' : '' ?>">
                        ...
                        <?php
                        if (isset($errorMessage['lastName'])) { ?>
                    ...
                    <div class="col-md-6 text-center form-group<?= isset($errorMessage['firstName']) ? ' has-danger' : '' ?>">
                        ...
                        <?php
                        if (isset($errorMessage['firstName'])) { ?>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2586.748200919306!2d2.9966251425738437!3d49.58363850471118!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e873ee4a089f73%3A0x8d6da9d49b4c873f!2s31%20Square%20de%20Lattre%20de%20Tassigny%2C%2060400%20Noyon!5e0!3m2!1sfr!2sfr!4v1580207930402!5m2!1sfr!2sfr" width="1888" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>        <!-- Footer start -->
